...
func TestAccDataSourceMackerelAWSIntegrationIAMRole(t *testing.T) {
	...
	if externalID == "" {
		t.Skip("EXTERNAL_ID environment variable is not set")
	}
	awsRoleArn := os.Getenv("AWS_ROLE_ARN")
	if awsRoleArn == "" {
		t.Skip("AWS_ROLE_ARN environment variable is not set")
	}
...
func TestAccDataSourceMackerelAWSIntegrationCredential(t *testing.T) {
	...
	if awsAccessKeyID == "" {
		t.Skip("AWS_ACCESS_KEY_ID environment variable is not set")
	}
	awsSecretAccessKey := os.Getenv("AWS_SECRET_ACCESS_KEY")
	if awsSecretAccessKey == "" {
		t.Skip("AWS_SECRET_ACCESS_KEY environment variable is not set")
	}
